                ...
                <div className="md:flex justify-center">
                    <div className="lg:w-1/3 md:w-2/4 shadow-md dark:shadow-gray-800">
                        <div className="rounded shadow bg-white dark:bg-slate-900 p-6">
                            ...
                            <p className="text-slate-400 mt-2">Por favor, introduzca su dirección de correo electrónico. Recibirá un enlace para crear una nueva contraseña por correo electrónico.</p>
                            ...
                            <form className="text-start mt-4">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="mb-4">
                                        <input type="submit" className="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-amber-400 hover:bg-amber-500 border-amber-400 hover:border-amberbg-amber-500 text-white rounded-md w-full" value="Enviar"/>
                                    </div>
    
                                    <div className="text-center">
                                        <span className="text-slate-400 me-2">Recordar contraseña? </span> <Link to="/login" className="text-slate-900 dark:text-white font-bold inline-block">Iniciar Sesión</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
