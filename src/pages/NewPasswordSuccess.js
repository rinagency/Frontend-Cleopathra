                    ...
                    <div className="md:flex justify-center">
                        <div className="lg:w-1/3 md:w-2/4 shadow-md dark:shadow-gray-800 flex flex-col items-center"> {/* Modificado */}
                            <div className="rounded shadow bg-white dark:bg-slate-900 p-6">
                                ...
                                <h5 className="text-xl font-semibold text-center mb-2">La contraseña se ha cambiado correctamente</h5>

                                <p className="text-slate-400 mt-2">Inicia sesión con tu nueva contraseña pulsa el siguiente boton y serás redirigido.</p>
                                <div className="mb-2"></div> {/* Agregado para crear un espacio */}
                                <div className="mb-4">
